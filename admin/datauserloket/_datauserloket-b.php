    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container">
                ...
                <caption>Panggil Antrian Pengaduan di Loket B</caption>
                <thead>
                    <tr>
                    <th scope="col">No</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($data['status'] == 1): ?>
                                    ...
                                    <a href='../componen/deactif.php?kodeb=<?php echo $data['kodeb']; ?>' class='btn btn-disable'>Panggil</a>
                                <?php else: ?>
                                    <a href='../componen/actif.php?kodeb=<?php echo $data['kodeb']; ?>&mejab=<?php echo $data['mejab']; ?>' class='btn btn-primary'>
                                        Panggil 
                                    </a>
                                <?php endif; ?>
                            </td>
                            <td>
                                ...
                                <audio id="audioPlayer" src="../../audio/a/<?= $data['kodeb'];?>.m4a" type="audio/mp4"></audio>
                            </td>
                            <td>
                                <?php if ($data['status'] == 1): ?>
