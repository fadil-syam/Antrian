    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
                    ...
                    <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="bi bi-volume-up-fill me-2"></i>Pangil Antrian</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <?php if ($admin['status5'] == 1): ?>
                                    <a href="_datauserloket-e.php" class="dropdown-item active">Loket 5</a>
                                <?php else: ?>
        ...
        <div class="content">
            ...
            <div class="container">
                ...
                <caption>Panggil Antrian Pengaduan di Loket E</caption>
                <thead>
                    <tr>
                    <th scope="col">No</th>
                ...
                <tbody>
                    <?php $query = mysqli_query($conn,"SELECT * from lokete");
                        $no=1;
                        while ($data = mysqli_fetch_array($query)){ ?>     
                        <tr>
                            <th scope="row"><?php echo $no;$no++; ?></th>
                            <td><?php echo $data['mejae']; ?></td>
                            <td><?php echo $data['kodee']; ?></td>
                            <td>
                                <?php if ($data['status'] == 1): ?>
                                    <!-- <button class="btn btn-secondary" disabled>Panggil</button> -->
                                    <a href='../componen/deactif.php?kodee=<?php echo $data['kodee']; ?>' class='btn btn-disable'>Panggil</a>
                                <?php else: ?>
                                    <a href='../componen/actif.php?kodee=<?php echo $data['kodee']; ?>&mejae=<?php echo $data['mejae']; ?>' class='btn btn-primary'>
                                        Panggil 
                                    </a>
                                <?php endif; ?>
                            </td>
                            <td>
                                ...
                                <audio id="audioPlayer" src="../../audio/a/<?= $data['kodee'];?>.m4a" type="audio/mp4"></audio>
                            </td>
                            <td>
                                <?php if ($data['status'] == 1): ?>
